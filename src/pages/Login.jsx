...
function SlideOne() {
  return (
    <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-sm mx-auto">
      {/* Background glow */}
      <ellipse cx="200" cy="160" rx="140" ry="100" fill="rgba(139,92,246,0.08)" />

      {/* Phone body */}
      <motion.rect
        x="130" y="40" width="140" height="240" rx="24"
        fill="rgba(15,31,61,0.9)" stroke="rgba(139,92,246,0.5)" strokeWidth="1.5"
        initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      />
      <rect x="155" y="50" width="90" height="8" rx="4" fill="rgba(139,92,246,0.3)" />

      {/* Chat bubbles on phone */}
      {[
        { x: 145, y: 80, w: 80, color: 'rgba(139,92,246,0.8)', align: 'left', delay: 0.5 },
        { x: 175, y: 110, w: 70, color: 'rgba(255,255,255,0.15)', align: 'right', delay: 0.7 },
        { x: 145, y: 140, w: 90, color: 'rgba(139,92,246,0.8)', align: 'left', delay: 0.9 },
      ...
      <motion.g animate={{ y: [-6, 6, -6] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}>
        <circle cx="310" cy="80" r="30" fill="rgba(139,92,246,0.15)" />
        <circle cx="310" cy="80" r="22" fill="rgba(139,92,246,0.25)" stroke="rgba(139,92,246,0.6)" strokeWidth="1" />
        <path d="M302 78 C302 73 318 73 318 78 L318 87 C318 89 316 91 310 91 C304 91 302 89 302 87 Z"
          fill="rgba(255,255,255,0.9)" />
        <rect x="307" y="81" width="6" height="6" rx="2" fill="rgba(139,92,246,0.8)" />
        <path d="M307 81 C307 78 313 78 313 81" stroke="rgba(139,92,246,0.8)" strokeWidth="1.5" fill="none" />
      </motion.g>
      ...
      {/* Connecting lines */}
      <motion.line x1="90" y1="120" x2="130" y2="140" stroke="rgba(139,92,246,0.3)" strokeWidth="1" strokeDasharray="4 4"
        animate={{ opacity: [0.2, 0.6, 0.2] }} transition={{ duration: 2, repeat: Infinity }} />
      <motion.line x1="270" y1="150" x2="320" y2="150" stroke="rgba(139,92,246,0.3)" strokeWidth="1" strokeDasharray="4 4"
...
function SlideTwo() {
  return (
    <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-sm mx-auto">
      <ellipse cx="200" cy="170" rx="130" ry="90" fill="rgba(139,92,246,0.06)" />

      {/* Two phones facing each other */}
      <motion.g initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
        <rect x="60" y="70" width="110" height="180" rx="18" fill="rgba(15,31,61,0.95)" stroke="rgba(139,92,246,0.4)" strokeWidth="1.5" />
        <rect x="80" y="82" width="70" height="6" rx="3" fill="rgba(139,92,246,0.3)" />
      ...
      <motion.g initial={{ x: 30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
        <rect x="230" y="70" width="110" height="180" rx="18" fill="rgba(15,31,61,0.95)" stroke="rgba(139,92,246,0.4)" strokeWidth="1.5" />
        <rect x="250" y="82" width="70" height="6" rx="3" fill="rgba(139,92,246,0.3)" />
        {[100, 125, 150, 175].map((y, i) => (
...
function SlideThree() {
  return (
    <svg viewBox="0 0 400 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-sm mx-auto">
      <ellipse cx="200" cy="160" rx="120" ry="90" fill="rgba(139,92,246,0.07)" />
      ...
      <motion.g animate={{ scale: [1, 1.04, 1] }} transition={{ duration: 3, repeat: Infinity }}>
        <motion.path
          ...
          fill="rgba(15,31,61,0.95)" stroke="rgba(139,92,246,0.7)" strokeWidth="2"
        ...
        {/* Lock in shield */}
        <rect x="187" y="118" width="26" height="22" rx="4" fill="rgba(139,92,246,0.8)" />
          ...
          <motion.g key={i}
            ...
            <motion.g animate={{ opacity: [0.5, 1, 0.5] }} transition={{ duration: 2, delay: i * 0.5, repeat: Infinity }}>
              <rect x={cx - 22} y={cy - 12} width="44" height="24" rx="12"
                fill="rgba(139,92,246,0.25)" stroke="rgba(139,92,246,0.5)" strokeWidth="1" />
      ...
      {[{ x: 80, y: 60 }, { x: 330, y: 80 }, { x: 70, y: 240 }, { x: 320, y: 230 }].map((s, i) => (
        <motion.g key={i} animate={{ opacity: [0, 1, 0], scale: [0.5, 1.2, 0.5] }}
          ...
          <line x1={s.x} y1={s.y - 8} x2={s.x} y2={s.y + 8} stroke="rgba(139,92,246,0.8)" strokeWidth="1.5" />
          <line x1={s.x - 8} y1={s.y} x2={s.x + 8} y2={s.y} stroke="rgba(139,92,246,0.8)" strokeWidth="1.5" />
        </motion.g>
      ))}
    </svg>
  );
