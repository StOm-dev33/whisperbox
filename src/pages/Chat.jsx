...
export default function Chat() {
  ...
  return (
    <div className="h-screen flex overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      {/* Sidebar */}
      <div className={`flex-shrink-0 w-full md:w-72 lg:w-80 h-full border-r flex flex-col ${showMobileList ? 'flex' : 'hidden md:flex'}`}
        ...
        <div className="px-4 md:px-6 py-4 flex-shrink-0" style={{ borderTop: '1px solid var(--border)' }}>
          <button onClick={handleLogout}
            className="flex items-center gap-2 text-sm w-full px-3 py-2.5 rounded-lg transition-colors"
